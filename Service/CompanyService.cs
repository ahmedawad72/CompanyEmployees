...
namespace Service
{
    ...
    internal sealed class CompanyService : ICompanyService
    {
        ...
        public async Task<(IEnumerable<CompanyDto> companies, string ids)> CreateCompanyCollectionAsync
                    (IEnumerable<CompanyForCreationDto> companyForCreationCollectionDto)
        {
            if (companyForCreationCollectionDto is null)
            {
                throw new CompanyCollectionBadRequestException();
            }

            var companyEntities = _mapper.Map<IEnumerable<Company>>(companyForCreationCollectionDto);
